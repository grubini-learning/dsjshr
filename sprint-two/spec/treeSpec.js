describe('tree', function() {
  ...
  it('should correctly detect node\'s parent', function() {
    tree.addChild(5);
    tree.addChild(6);
    tree.children[0].addChild(7);
    tree.children[1].addChild(8);
  ...
  it('should remove specified child from parent', function() {
    tree.addChild(5);
    tree.addChild(6);
    tree.children[0].addChild(7);
    tree.children[1].addChild(8);
  ...
  it('should execute a callback on each node in the tree', function() {
    ...
    tree.children[0].addChild(7);
    tree.children[1].addChild(8);
    expect(tree.traversal(double)).to.eql([10, 10, 14, 12, 16]);
  });
});
